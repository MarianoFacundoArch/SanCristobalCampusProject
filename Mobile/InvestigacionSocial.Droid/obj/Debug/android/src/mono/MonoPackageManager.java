...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "InvestigacionSocial.Droid.dll" comes first in this list. */
		"InvestigacionSocial.Droid.dll",
		"FFImageLoading.dll",
		...
		"UXDivers.Artina.Shared.Repeater.dll",
		"UXDivers.Artina.Shared.Tab.dll",
